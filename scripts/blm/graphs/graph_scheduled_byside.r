...
d <- read.csv("../data/graph_scheduled_byside.csv")
...
wetlow <- nrow(subset(d, side=='wet' & (rcp == 'rcp45' | is.na(rcp))))
wethigh <- nrow(subset(d, side=='wet' & (rcp == 'rcp45' | is.na(rcp))))
drylow <- nrow(subset(d, side=='dry' & (rcp == 'rcp85' | is.na(rcp))))
dryhigh <- nrow(subset(d, side=='dry' & (rcp == 'rcp85' | is.na(rcp))))
